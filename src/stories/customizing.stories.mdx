...
If you want, you can work on `custom-theme.scss` file that's ready to use. Also, we created two themes to use as examples: [soft-blue](?path=/docs/theming-themes-soft-blue--page) and [midnight](?path=/docs/theming-themes-midnight--page).
