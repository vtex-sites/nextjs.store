...
To build your new theme, just create a new `.scss` file on `src/styles/themes` and overwrite the tokens you want. We created two themes to use as examples: `soft-blue` and `midnight`.
