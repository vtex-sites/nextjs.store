...
<TokenTable>
  <TokenRow token="--fs-cart-sidebar-height" value="100%" />
  <TokenRow
...
<TokenTable>
  ...
  <TokenDivider />
  <TokenRow
    token="--fs-cart-sidebar-header-close-button-margin-right"
...
<TokenTable>
  <TokenRow token="--fs-cart-sidebar-footer-margin-top" value="auto" />
  <TokenRow
  ...
  <TokenDivider />
  <TokenRow
    token="--fs-cart-sidebar-footer-checkout-button-width"
    value="100%"
  />
</TokenTable>
