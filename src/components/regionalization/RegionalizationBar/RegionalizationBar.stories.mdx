...
The `RegionalizationBar` is part of [Regionalization](?path=/docs/features-regionalization-default--default-button) feature.
...
<TokenTable>
  ...
  <TokenRow
    ...
    isColor
  />
  <TokenRow token="--fs-regionalization-bar-border" value="0" />
</TokenTable>
...
<TokenTable>
  ...
  />
  <TokenRow
    token="--fs-regionalization-bar-message-font-weight"
