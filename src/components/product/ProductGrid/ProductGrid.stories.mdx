...
<Meta title="Organisms/ProductGrid" component={ProductGrid} />
...
It's a section generally used on PDP pages to list the products available on the store.
...
<BestPractices>
  <BestPracticesRule
    recommendedDescription="Respect ProductCard content's width considering the space available on the page."
    discouragedDescription="Avoid using a lot of ProductCards on the same row, this could lead to unwanted horizontal scroll."
  />
</BestPractices>
