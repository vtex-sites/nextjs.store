...
A `Badge` used to show product discounts. You can see its usage on [ProductCard](?path=/docs/molecules-productcard--overview-default).

</header>

## Overview

The `DiscountBadge` component uses [Badge](https://www.faststore.dev/reference/ui/atoms/Badge) as base.
