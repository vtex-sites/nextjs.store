...
A component mainly used in Product Details Pages (PDPs) to display all the available variants for a given product.

</header>

## Overview

The `SkuSelector` component is directly related to the `Selectors` component, the latter being responsible for handling the behavior (e.g., navigating between SKUs) and rendering of the former.
