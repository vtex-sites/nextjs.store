...
<TokenTable>
  <TokenRow token="--fs-gift-height" value="var(--fs-spacing-13)" />
  <TokenRow token="--fs-gift-gap" value="var(--fs-spacing-2)" />
  <TokenDivider />
  <TokenRow token="--fs-gift-border-width" value="var(--fs-border-width)" />
  <TokenRow
    token="--fs-gift-border-color"
    value="var(--fs-border-color-light-active)"
    isColor
  />
...
<TokenTable>
  <TokenRow token="--fs-gift-title-margin-bottom" value="var(--fs-spacing-0)" />
  <TokenRow token="--fs-gift-title-line-height" value="1.25" />
  <TokenRow
    token="--fs-gift-title-text-size"
...
<TokenTable>
  ...
  <TokenRow token="--fs-gift-icon-color" value="var(--fs-gift-title-color)" />
  <TokenRow token="--fs-gift-icon-bkg-color" value="var(--fs-gift-body-bkg)" />
</TokenTable>
