...
<table>
  ...
  <tbody>
    ...
    <tr>
      <td>
        <code>--fs-checkbox-checked-border-color-hover</code>
      </td>
      <td>
        <div style={{ backgroundColor: 'var((--fs-border-color-hover)' }} />
        <code>var((--fs-border-color-hover)</code>
    ...
    <tr>
      <td>
        <code>--fs-checkbox-checked-shadow-hover</code>
      </td>
      <td>
        <code>
          0 0 0 var(--fs-checkbox-border-width)
  ...
  <tbody>
    <tr>
      ...
      <td>
        ...
        <code>var(--fs-color-body-bkg)</code>
      </td>
    </tr>
    <tr>
      <td>
    ...
    <tr>
      <td>
        <code>--fs-checkbox-partial-bkg-color-hover</code>
      </td>
      <td>
        <div style={{ backgroundColor: 'var(--fs-color-primary-bkg-light)' }} />
        <code>var(--fs-color-primary-bkg-light)</code>
