...
export const Template = (args) => (
  <EmptyState {...args}>The list is empty</EmptyState>
)
  ...
  <article>
    <div style={{ height: '250px' }}>
      <a href="?path=/docs/organisms-emptystate-emptycart--default-story">
        <img width="245px" src="https://vtexhelp.vtexassets.com/assets/docs/src/empty-car___33a48f795ba03130f1bc81f1c075143d.png"/>
      </a>
    </div>
