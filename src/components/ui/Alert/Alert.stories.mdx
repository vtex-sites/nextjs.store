...
<TokenTable>
  <TokenRow
    ...
    valueGlobal="var(--fs-color-highlighted-text)"
    isColor
  />
  <TokenRow
...
<TokenTable>
  ...
  <TokenRow
    ...
    valueGlobal="var(--fs-color-highlighted-bkg)"
    isColor
  />
  <TokenRow
...
<BestPractices>
  <BestPracticesRule
    ...
    descriptionGood="Prefer short messages to inform about a behavior of a system, feature or page."
    componentBad={
      <Alert
        icon={<Icon name="ShieldCheck" width={24} height={24} />}
    ...
    descriptionBad="Don't use really long texts. Some important information can be lost."
  />
</BestPractices>
