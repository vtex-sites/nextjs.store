...
<Meta
  title="Features/ShippingSimulation/Overview"
...
export const TemplateProvider = (args) => {
  return (
    <SessionProvider initialState={{ postalCode: '1234' }}>
      <ShippingSimulation {...args} style={{ border: 0 }} />
    </SessionProvider>
  )
}
...
<TokenTable>
  ...
  <TokenDivider />
  <TokenRow
    token="--fs-shipping-simulation-padding-tablet"
    value="var(--fs-spacing-5)"
  />
  <TokenRow
    token="--fs-shipping-simulation-border-width-tablet"
    value="var(--fs-border-width)"
  />
  <TokenRow
    token="--fs-shipping-simulation-border-color-tablet"
    value="var(--fs-border-color-light)"
    isColor
  />
  <TokenRow
    token="--fs-shipping-simulation-border-radius-bottom-tablet"
...
<TokenTable>
  ...
  />
  <TokenRow
    token="--fs-shipping-simulation-table-cell-text-align-last"
    value="right"
  />
</TokenTable>
