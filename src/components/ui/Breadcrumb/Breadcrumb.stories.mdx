...
<TokenTable>
  <TokenRow
    token="--fs-breadcrumb-link-first-padding"
    value="var(--fs-spacing-1)"
  />
  <TokenDivider />
  <TokenRow
    token="--fs-breadcrumb-link-first-border-radius"
    value="var(--fs-border-radius-circle)"
  />
  <TokenDivider />
  <TokenRow
    token="--fs-breadcrumb-link-first-hover-background-color"
...
<TokenTable>
  <TokenRow
    token="--fs-breadcrumb-item-icon-color"
...
<TokenTable>
  <TokenRow
    token="--fs-breadcrumb-dropdown-button-padding"
    value="0 calc(var(--fs-spacing-0) / 2)"
  />
  <TokenRow
    token="--fs-breadcrumb-dropdown-button-margin"
    value="calc(var(--fs-spacing-0) / 4)"
  />
  <TokenDivider />
  <TokenRow
...
<TokenTable>
  <TokenRow
    token="--fs-breadcrumb-dropdown-button-text-size"
    value="var(--fs-text-size-3)"
  />
  <TokenRow
    token="--fs-breadcrumb-dropdown-button-text-weight"
    value="var(--fs-text-weight-bold)"
  />
  <TokenRow
    token="--fs-breadcrumb-dropdown-button-text-transform"
    value="translate(rem(1px), rem(-6px))"
  />
</TokenTable>
...
<TokenTable>
  <TokenRow
    token="--fs-breadcrumb-item-current-text-color"
