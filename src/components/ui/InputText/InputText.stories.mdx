...
<TokenTable>
  ...
  <TokenRow token="--fs-input-border-color" value="var(--fs-border-color)" />
  <TokenRow
    token="--fs-input-border-color-hover"
    value="var(--fs-border-color-active)"
  />
  <TokenDivider />
  <TokenRow token="--fs-input-text-color" value="var(--fs-color-text)" />
...
<TokenTable>
  <TokenRow
    token="--fs-input-message-size"
    value="var(--fs-text-size-legend)"
  />
  <TokenRow token="--fs-input-message-line-height" value="1.1" />
  <TokenRow
    token="--fs-input-message-error-color"
    value="var(--fs-color-danger-text)"
    isColor
  />
  <TokenRow token="--fs-input-message-margin-top" value="var(--fs-spacing-0)" />
</TokenTable>
