  ...
  <SearchInputProvider>
    <SectionList grid="grid">
      ...
      <SectionItem
        ...
        description={
          <>
            Card to show details of the product and suggest in <code>SearchDropdown</code>.
          </>
        }
      >
    ...
    <SectionList grid="grid">
      <SectionItem
        ...
        description={
          <>
            Responsible for showing the history of the most recent terms researched by the user.
          </>
        }
      >
