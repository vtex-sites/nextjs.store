...
Card to show details of product and suggest in search dropdown.

</header>

## Overview

The `SuggestionProductCard` differs from `ProductCard` because it is used in Search feature and is called by Suggestion component.
